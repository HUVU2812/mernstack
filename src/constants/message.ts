export const USERS_MESSAGES = {
  ...
  //EMAI
  REGISTER_SUCCESS: 'Email successfully',
  //login success
  LOGIN_SUCCESS: 'Login is successed',
  //access
  ACCESS_TOKEN_IS_REQUIRED: 'Access_token is required',
  //refresh
  REFRESH_TOKEN_IS_REQUIRED: 'Refresh_token is required',
  //
  REFRESH_TOKEN_IS_INVALID: 'Refresh _token is invalid',
  //
  LOGOUT_SUCCESS: 'Logout is successed'
} as const
